...
namespace SugarChat.IntegrationTest
{
    public class UserRepositoryTest : TestBase
    {
        ...
        {
            var id = Guid.NewGuid();
            var newUser = new User(id, "https://sugarchat.com", new RegisterInfo(), "sugarchat_publicid", "叶子", "叶子的描述", UserStatus.Hidden, "cooper", "huang", new DateTime(1994, 11, 17));
        ...
        public async Task Should_Update_One_User()
        {
            ...
            var newUpdateUser = new User(insertedUser.Id,
